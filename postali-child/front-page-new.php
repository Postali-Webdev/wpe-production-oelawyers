...
<section class="homepage-hero" style="background-image:url(<?php the_field('background_image'); ?>)">
    <div class="container">
...
<section class="panel-2 grey">
    <div class="container wide">
        <div class="columns">
            ...
            <div class="column-33" style="background-image:url(<?php the_field('panel_2_background_image'); ?>">
                <?php if ( is_page(705) ) { ?>
...
<section class="panel-3 white">
    <div class="container">
        ...
        <div class="columns">
            <div class="column-50">
                <?php the_field('panel_3_left_column'); ?>
            </div>
            <div class="column-50">
                <?php the_field('panel_3_right_column'); ?>
            </div>
        </div>
    <div>
</section>
...
<section class="panel-7" style="background-image:url(<?php the_field('panel_7_background_image'); ?>)" class="test">
    <div class="container">
        <div class="columns">
            <div class="column-50">
