...
function testimonial_language() {

	$labels = array(
		'name'                       => _x( 'Testimonial Language', 'Testimonial Languages' ),
		'singular_name'              => _x( 'Testimonial Language', 'Testimonial Language' ),
		'menu_name'                  => __( 'Testimonial Language' ),
		'all_items'                  => __( 'All Testimonial Languages' ),
		'new_item_name'              => __( 'New Testimonial Language' ),
		'add_new_item'               => __( 'Add Testimonial Language' ),
		'edit_item'                  => __( 'Edit Testimonial Language' ),
		'update_item'                => __( 'Update Testimonial Language' ),
		'view_item'                  => __( 'View Testimonial Language' ),
		'separate_items_with_commas' => __( 'Separate Testimonial Languages with commas' ),
		'add_or_remove_items'        => __( 'Add or remove Testimonial Languages' ),
		'popular_items'              => __( 'Popular Testimonial Languages' ),
		'search_items'               => __( 'Search Testimonial Languages' ),
		'not_found'                  => __( 'Not Found' ),
		'no_terms'                   => __( 'No Testimonial Languages' ),
	);
	$args = array(
		'labels'                     => $labels,
		'hierarchical'               => false,
	...
	register_taxonomy( 'testimonial_language', array( 'testimonials' ), $args );

}
add_action( 'init', 'testimonial_topic', 0 );
add_action( 'init', 'testimonial_language', 0 );
